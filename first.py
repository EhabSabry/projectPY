...
class Ui_Form_3(object):
        ...
        "")
                ...
                self.pushButton_12.clicked.connect(self.insertDataCs)
                self.pushButton_13.clicked.connect(self.insertDataIt)
                self.pushButton_14.clicked.connect(self.insertDataIs)
                self.pushButton_11.clicked.connect(self.insertDataSe)
